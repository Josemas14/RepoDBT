...
with base_2002 as (
    ...
    select 
        fecha::date as fecha,
        cod_est,
        v_max:: FLOAT as v_max,
        v_med:: FLOAT as v_med,
        v_min:: FLOAT as v_min,
        cv1:: FLOAT as cv1,
        cv2:: FLOAT as cv2,
        cv3:: FLOAT as cv3,
        cv4:: FLOAT as cv4,
        direccion:: FLOAT as direccion
...
base_2018 as (
    ...
    select 
        ...
        v_med:: FLOAT as v_med,
        v_min:: FLOAT as v_min,
        sumadecv1:: FLOAT as cv1,
        sumadecv2:: FLOAT as cv2,
        sumadecv3:: FLOAT as cv3,
        sumadecv4:: FLOAT as cv4,
        promediodedireccion:: FLOAT as direccion
